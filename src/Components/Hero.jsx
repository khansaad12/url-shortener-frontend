...
export default function Hero() {
  ...
  <div className="max-w-7xl mx-auto pt-20 pb-16 px-4 sm:py-24 sm:px-6 lg:px-8 text-center">
    ...
    >
      <h1 className="text-4xl font-extrabold sm:text-5xl lg:text-6xl flex flex-col items-center justify-center gap-4">
        <span className="block text-gray-900 dark:text-white">
          Supercharge Your Links with
        </span>

        {/* Responsive Bitlink logo */}
        <span className="block w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg mx-auto">
          <svg
      ...
      <p className="mt-6 max-w-lg mx-auto text-xl text-gray-600 dark:text-gray-300">
        The most powerful URL shortener with advanced analytics, custom domains,
